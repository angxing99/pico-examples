...
#warning i2c/mpu6050_i2c example requires a board with I2C pins
    ...
    while (1)
    {
        ...
        accX = ((float)acceleration[0]) / 16384.0;
        accY = ((float)acceleration[1]) / 16384.0;
        accZ = ((float)acceleration[2]) / 16384.0;

        gyroX = ((float)gyro[0]) / 65.5;
        gyroY = ((float)gyro[1]) / 65.5;
        gyroZ = ((float)gyro[2]) / 65.5;
